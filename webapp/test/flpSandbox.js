		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#arcomodatav4b1project2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomodatav4b1project2-display": {
								"semanticObject": "arcomodatav4b1project2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.odatav4b1project2",
									"url": sap.ui.require.toUrl("ar/com/odatav4b1project2")
								}
							}
						}
					}
